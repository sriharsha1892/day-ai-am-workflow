...
// MCP server ([mcp_servers.myra]) set up by the one-click installer (scripts/make-am-installer.mjs
// -> myra-setup-<am>.cmd). This script used to run `codex mcp add day-ai`, which adds a DIRECT Day
...
console.log('');
console.log('  • To set up:  ask your admin for your one-click installer (myra-setup-<you>.cmd).');
